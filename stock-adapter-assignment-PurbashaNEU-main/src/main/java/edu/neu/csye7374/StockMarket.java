...
public class StockMarket {
   ...
   public void showTrades()
   {
	   ...
	   for (Stock t : tradedstocks)
	    {
		   System.out.println("Name: " + t.getID()+", "+t.getTradeType()+" at price: "+t.getPrice());
		}
   } 
   ...
   public static void demo() {
	...
	System.out.println("\n---------------------");
	   ...
	   System.out.println("\nAdapter Demo:");
	   StockPaymentAdapter.demo();
	   System.out.println("\n---------------------");

	   System.out.println("\nPayments:\n");


	   List<String> paymentMethods = Arrays.asList("GooglePay", "BankTransfer", "PayPal", "ApplePay");

	   StockPaymentAPI stockPayment;

	   for(Stock st: stkMkt.stocks) {
		   Random r = new Random();
		   int randomitem = r.nextInt(paymentMethods.size());
		   String randomPaymentMethod = paymentMethods.get(randomitem);
		   System.out.println(randomPaymentMethod + " Payment for " + st.getID() + ":");
		   stockPayment = new StockPaymentAdapter();
		   stockPayment.Payment(randomPaymentMethod, st.getPrice());
		   System.out.println("");
	   }
	   System.out.println("\n---------------------");
